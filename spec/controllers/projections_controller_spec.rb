...
RSpec.describe ProjectionsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested projection as @projection" do
      projection = Projection.create! valid_attributes
      get :show, {:id => projection.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested projection as @projection" do
      projection = Projection.create! valid_attributes
      get :edit, {:id => projection.to_param}, valid_session
      expect(assigns(:projection)).to eq(projection)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Projection" do
        expect {
          post :create, {:projection => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved projection as @projection" do
        post :create, {:projection => invalid_attributes}, valid_session
        expect(assigns(:projection)).to be_a_new(Projection)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested projection" do
        projection = Projection.create! valid_attributes
        put :update, {:id => projection.to_param, :projection => new_attributes}, valid_session
        projection.reload
      ...
      it "assigns the requested projection as @projection" do
        projection = Projection.create! valid_attributes
        put :update, {:id => projection.to_param, :projection => valid_attributes}, valid_session
        expect(assigns(:projection)).to eq(projection)
      end
    ...
    context "with invalid params" do
      it "assigns the projection as @projection" do
        projection = Projection.create! valid_attributes
        put :update, {:id => projection.to_param, :projection => invalid_attributes}, valid_session
        expect(assigns(:projection)).to eq(projection)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested projection" do
      projection = Projection.create! valid_attributes
      expect {
        delete :destroy, {:id => projection.to_param}, valid_session
      }.to change(Projection, :count).by(-1)
    end
